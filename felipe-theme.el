...
(custom-theme-set-faces
 ...
 '(font-lock-constant-face ((t (:foreground "DarkOrchid1"))))
 ...
 '(default ((t (:family "DejaVu Sans Mono" :foundry "PfEd" :width normal :height 107 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#232627" :background "#fcfcfc" :stipple nil :inherit nil)))))

(provide-theme 'felipe)
